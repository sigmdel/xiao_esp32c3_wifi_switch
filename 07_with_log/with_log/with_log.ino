 ...
 *
 * New: 
 *   Added very basic configuration.
 *   Added private logging facility.
 *   Added version.
 *   Started to remove blocking functions.
 *     - no longer waiting for WiFi connection in setup()
 *     - no blocking if the temperature sensor is missing or defective
 *     - shorter timeout on HTTP requests to Domoticz
 * 
