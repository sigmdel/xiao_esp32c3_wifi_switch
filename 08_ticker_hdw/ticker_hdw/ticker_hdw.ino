 ...
 *
 * New: 
 *   run hardware on a ticker
 *   buffer HTTP request in a circular FIFO queue
 *     - allows for longer timeouts on HTTP requests
 *     - button remains responsive even when WiFi is disconnected
 *     
 * 
